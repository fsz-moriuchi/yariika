...
<body>
	...
	<div class="page-container">
		...
		<div class="facility-info-card">
			<h1>施設情報確認</h1>
			<p class="welcome-message">登録されている施設情報を確認できます。</p>

			<div class="facility-info-table-wrap">
				<table border="1" class="facility-info-table">
					<tr>
						<th>施設名</th>
						<td><c:out value="${facilityInfo.facilityName}" /></td>
					</tr>
					<tr>
						<th>電話番号</th>
						<td><c:out value="${facilityInfo.tel}" /></td>
					</tr>
					<tr>
						<th>住所</th>
						<td><c:out value="${facilityInfo.address}" /></td>
					</tr>
					<tr>
						<th>メールアドレス</th>
						<td><c:out value="${facilityInfo.mail}" /></td>
					</tr>
					<tr>
						<th>開店時間</th>
