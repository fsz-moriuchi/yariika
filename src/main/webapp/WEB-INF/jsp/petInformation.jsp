...
<body>
	...
	<form action="PetRegisterServlet" method="post"
		...
		1.カテゴリー： <label> <input type="radio" name="categoryId"
			value="1"
		...
		</label> <br> 2.店舗ID：${loginFacilityId} <input type="hidden"
			name="facilityId" value="${loginFacilityId}"> <br>
		3.名前： <label> <input type="text" name="name"
			value="${empty petDetail ? '' : petDetail.name}" autocomplete="off"><br>
		</label> 4.性別： <label> <input type="radio" name="gender" value="male"
		...
		</label> 5.年齢： <label> <input type="number" name="age" min="0"
			value="${empty petDetail ? '' : petDetail.age}" required
			autocomplete="off"><br>
		</label> 6.色と柄：<br> <label> <input type="checkbox" name="color"
		...
		</label> <label> <input type="checkbox" name="color" value="spotted"
		...
		</label> <label> <input type="checkbox" name="color" value="curlyHair"
		...
		</label> <label> <input type="checkbox" name="color" value="shortHair"
			<%=colorText.contains("shortHair") ? "checked" : ""%>>短毛<br>
		</label> 7.サイズ： <label> <input type="radio" name="pet_size"
			value="small"
			${not empty petDetail and petDetail.pet_size == "small"?"checked":"" }>小型
		</label> <label> <input type="radio" name="pet_size" value="medium"
		...
		</label> 8.ワクチン： <label> <input type="radio" name="vaccine"
			value="vaccineDone"
			${not empty petDetail and petDetail.vaccine == "vaccineDone"?"checked":"" }>接種済み
		</label> <label> <input type="radio" name="vaccine" value="vaccineYet"
			${not empty petDetail and petDetail.vaccine == "vaccineYet"?"checked":"" }>未接種<br>
		</label> 8.生体価格： <label> <input type="number" name="price" min="0"
		...
		<br> 10.画像： <input type="file" name="imageFile" accept="image/*"><br>
