...
%> <label class="pet-survey-choice-item">
...
<c:choose>
<c:when test="${empty petID}"> <input type="submit" value="登録">
</c:when>
<c:otherwise> <input type="submit" value="更新"> <input type="hidden" name="petID" value="${petID}">
</c:otherwise>
</c:choose>
