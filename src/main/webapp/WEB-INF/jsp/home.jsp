...
<body>
	...
	<c:if test="${not empty sessionScope.userId}">
		...
		<form action="HomeServlet" method="get">
			...
			<input type="hidden" name="clickSearch" value="true"> カテゴリー：
			...
			</select> <br> 性別： <select name="gender">
			...
			<label> <input type="checkbox" name="color" value="white"
			...
			</select> <br> 年齢： <select name="ageRange">
			...
			</select> <br> 価格： <select name="priceRange">
				...
				<option value="price100001to300000"
					${selectedPriceRange == "price100001to300000" ? "selected" : ""}>100,001円
					~ 300,000円</option>

				<option value="price300001to500000"
					${selectedPriceRange == "price300001to500000" ? "selected" : ""}>300,001円
					~ 500,000円</option>

				<option value="price500001up"
					${selectedPriceRange == "price500001up" ? "selected" : ""}>500,001円以上</option>

			</select> <br> 並び順： <select name="sort">
